...
MKDIRS="sh /home/jholt/dl/ncurses-5.7/mkdirs.sh"
...
*.[0-9]*)
	...
	if test ! -f /home/jholt/dl/ncurses-5.7/man_alias.sed ; then
cat >>/home/jholt/dl/ncurses-5.7/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TPUT@,tput,
CF_EOF2
		echo "...made /home/jholt/dl/ncurses-5.7/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/jholt/dl/ncurses-5.7/man_alias.sed | sort -u`
	cf_target=`grep "^$cf_source" /home/jholt/dl/ncurses-5.7/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/jholt/dl/ncurses-5.7/man_alias.sed \
		< $i | sed -f /home/jholt/dl/ncurses-5.7/edit_man.sed >$TMP
